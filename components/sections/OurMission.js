  ...
  return (
    <div className='mt-2 text-black select-none flex flex-row flex-wrap justify-center items-start font-paragraph'>
      ...
      <div className='p-10 md:p-0 text-prose w-full md:w-1/2'>
        ...
        <p className='mt-2'>
          I started Third Pig because I believe that things simply don't have to
          be this way.
        </p>
        <p className='mt-2'>
        ...
        <p className='mt-2'>
          We'll always highlight to you the simplest available solution and will
          always try to suggest something small over something that will allow
          us to invoice more.
        </p>
        <p className='mt-2'>
